...
public class WeatherAPIScript : MonoBehaviour
{
    ...
    //    string url = "http://api.openweathermap.org/data/2.5/weather?lat=43.7230&lon=10.3966&APPID=&units=imperial";
        string url = "http://api.openweathermap.org/data/2.5/weather?lat=43.7230&lon=10.3966&APPID=7a3f8b015b2086e1a8d7e60806e9d8d1&units=imperial";
